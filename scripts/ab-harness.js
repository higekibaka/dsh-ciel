 ...
 */
const { chromium } = require('/home/example/deepseek-harness/node_modules/.pnpm/playwright@1.61.1/node_modules/playwright')
...
;(async () => {
  ...
  const browser = await chromium.launch({ executablePath: '/home/example/.local/bin/dsh-chrome', args: ['--no-sandbox'] })
